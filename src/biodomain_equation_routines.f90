...
CONTAINS
  ...
  SUBROUTINE BIODOMAIN_CONTROL_LOOP_PRE_LOOP(CONTROL_LOOP,ERR,ERROR,*)
    ...
    INTEGER(INTG) :: OUTPUT_ITERATION_NUMBER,CURRENT_LOOP_ITERATION,ITERATION,ITERATION_PHASE
     ...
     ! CALL WRITE_STRING(GENERAL_OUTPUT_TYPE,"  the current iteration number is ",ERR,ERROR,*999)
      ...
      CASE(PROBLEM_CONTROL_TIME_LOOP_TYPE)
        ...
        IF(ASSOCIATED(TIME_LOOP)) THEN
                    ...
                    IF(ASSOCIATED(EQUATIONS_SET)) THEN
                      ...
                      IF(ASSOCIATED(INDEPENDENT_FIELD)) THEN
                        ...
                        IF(ASSOCIATED(FIELD_VARIABLE)) THEN
                          ...
                          WRITE(INPUT_FILE,'("./input/Ve/Ve_VALUES_",I0,".dat")') ITERATION_PHASE
                          ...
                          DO node_idx=1,SIZE(EXTRACELLULAR_NODES) 
                            ...
                            & FIELD_VALUES_SET_TYPE,1,1,EXTRACELLULAR_NODES(node_idx),1,EXTRACELLULAR_VALUES(node_idx), &
                            & ERR,ERROR,*999) 
                            WRITE(*,*) EXTRACELLULAR_VALUES(node_idx) 
                          ENDDO
                          CALL FIELD_PARAMETER_SET_UPDATE_START(EQUATIONS_SET%INDEPENDENT%INDEPENDENT_FIELD, &
                            & FIELD_U_VARIABLE_TYPE, & 
                            & FIELD_VALUES_SET_TYPE,ERR,ERROR,*999)
                          CALL FIELD_PARAMETER_SET_UPDATE_FINISH(EQUATIONS_SET%INDEPENDENT%INDEPENDENT_FIELD, & 
                            & FIELD_U_VARIABLE_TYPE, & 
                            & FIELD_VALUES_SET_TYPE,ERR,ERROR,*999)
          ...
          ENDIF
        ELSE
          LOCAL_ERROR="TIME LOOP IS NOT ASSOCIATED"
          CALL FLAG_ERROR(LOCAL_ERROR,ERR,ERROR,*999) 
        ENDIF 
      CASE DEFAULT
                    ...
                    IF(ASSOCIATED(EQUATIONS_SET)) THEN
                      ...
                      IF(ASSOCIATED(PARENT_LOOP)) THEN
                        ...
                        IF(ASSOCIATED(TIME_LOOP_PARENT)) THEN
                          ...
                          FILENAME="./output/"//"Time_"//TRIM(NUMBER_TO_VSTRING(DEPENDENT_REGION%USER_NUMBER,"*",ERR,ERROR))// &
...
999 CALL ERRORS("BIODOMAIN_CONTROL_LOOP_POST_LOOP",ERR,ERROR)
  ...
  SUBROUTINE BIODOMAIN_EQUATION_EQUATIONS_SET_SETUP(EQUATIONS_SET,EQUATIONS_SET_SETUP,ERR,ERROR,*)
    ...
    INTEGER(INTG) :: component_idx,dimension_idx,DIMENSION_MULTIPLIER,GEOMETRIC_COMPONENT_NUMBER,GEOMETRIC_SCALING_TYPE, &
      & NUMBER_OF_DIMENSIONS,NUMBER_OF_MATERIALS_COMPONENTS,GEOMETRIC_MESH_COMPONENT,I,SOURCE_FIELD_NUMBER_OF_COMPONENTS, &
        ...
        CASE(EQUATIONS_SET_SETUP_START_ACTION)
          ...
          CASE(EQUATIONS_SET_MONODOMAIN_EQUATION_TYPE)
            IF(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD_AUTO_CREATED) THEN
              ...
              IF(EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_NO_SUBTYPE .OR. &
                 & EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_QUASI_MONODOMAIN_SUBTYPE) THEN
...
!! \todo allow for no rhs variable and so eliminate one of the flux variables
            ...
            CASE(EQUATIONS_SET_QUASI_MONODOMAIN_SUBTYPE)
              IF(EQUATIONS_SET%INDEPENDENT%INDEPENDENT_FIELD_AUTO_CREATED) THEN
                ...
                CALL FIELD_VARIABLE_LABEL_SET(EQUATIONS_SET%INDEPENDENT%INDEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE, &
                  & "Extracellular Potnetial",ERR,ERROR,*999)
            ...
            IF(ASSOCIATED(EQUATIONS_MATERIALS)) THEN
              IF(EQUATIONS_MATERIALS%MATERIALS_FIELD_AUTO_CREATED) THEN
                ...
                IF(EQUATIONS_SET%TYPE==EQUATIONS_SET_MONODOMAIN_EQUATION_TYPE) THEN
                  ...
                  !Monodomain. Materials field components are 4 plus one for each dimension i.e., Am,Cm,gr,Vr and \sigma
                    NUMBER_OF_MATERIALS_COMPONENTS=NUMBER_OF_DIMENSIONS+4
                ...
                ENDDO !component_idx
                IF (EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_QUASI_MONODOMAIN_SUBTYPE) THEN
                   ! set the gr to be constant interpolation/ and it is placed after Am,Cm, Dimenssions=>Number_of_dimentions+3
                  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                    & NUMBER_OF_DIMENSIONS+3,GEOMETRIC_COMPONENT_NUMBER,ERR,ERROR,*999)
                  CALL FIELD_COMPONENT_INTERPOLATION_SET(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                    & NUMBER_OF_DIMENSIONS+3,FIELD_CONSTANT_INTERPOLATION,ERR,ERROR,*999)
                  CALL FIELD_COMPONENT_LABEL_SET(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, & 
                    & NUMBER_OF_DIMENSIONS+3,"gr",ERR,ERROR,*999)
                   ! set the Vr to be constant interpolation/ and it is placed after Am,Cm, Dimenssions, gr =>Number_of_dimentions+4
                  CALL FIELD_COMPONENT_MESH_COMPONENT_SET(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                    & NUMBER_OF_DIMENSIONS+4,GEOMETRIC_COMPONENT_NUMBER,ERR,ERROR,*999)
                  CALL FIELD_COMPONENT_INTERPOLATION_SET(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                    & NUMBER_OF_DIMENSIONS+4,FIELD_CONSTANT_INTERPOLATION,ERR,ERROR,*999)
                  CALL FIELD_COMPONENT_LABEL_SET(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, & 
                    & NUMBER_OF_DIMENSIONS+4,"Vr",ERR,ERROR,*999)
                ENDIF
        ...
        CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
          ...
          IF(ASSOCIATED(EQUATIONS_MATERIALS)) THEN
            IF(EQUATIONS_MATERIALS%MATERIALS_FIELD_AUTO_CREATED) THEN
              ...
              IF(EQUATIONS_SET%TYPE==EQUATIONS_SET_MONODOMAIN_EQUATION_TYPE) THEN
                IF (EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_QUASI_MONODOMAIN_SUBTYPE) THEN 
                  !Monodomain. Materials field components are 2 plus one for each dimension i.e., Am,Cm,gr,Vr and \sigma
                  NUMBER_OF_MATERIALS_COMPONENTS=NUMBER_OF_DIMENSIONS+4
                  DIMENSION_MULTIPLIER=1
                ELSE
                 !Monodomain. Materials field components are 2 plus one for each dimension i.e., Am, Cm and \sigma
              ...
              !Now set Cm
              CALL FIELD_COMPONENT_VALUES_INITIALISE(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                & FIELD_VALUES_SET_TYPE,2,0.01_DP,ERR,ERROR,*999)
              !Now set gr
              IF (EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_QUASI_MONODOMAIN_SUBTYPE) THEN 
                CALL FIELD_COMPONENT_VALUES_INITIALISE(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                  & FIELD_VALUES_SET_TYPE,NUMBER_OF_DIMENSIONS+3,0.07_DP,ERR,ERROR,*999)
                CALL FIELD_COMPONENT_VALUES_INITIALISE(EQUATIONS_MATERIALS%MATERIALS_FIELD,FIELD_U_VARIABLE_TYPE, &
                  & FIELD_VALUES_SET_TYPE,NUMBER_OF_DIMENSIONS+4,-70.0_DP,ERR,ERROR,*999)
              ENDIF
      ...
      CASE(EQUATIONS_SET_SETUP_SOURCE_TYPE)
        SELECT CASE(EQUATIONS_SET_SETUP%ACTION_TYPE)
        CASE(EQUATIONS_SET_SETUP_START_ACTION)
          !IF (EQUATIONS_SET%SUBTYPE==EQUATIONS_SET_QUASI_MONODOMAIN_SUBTYPE)
           ...
           ELSE
            ...
            ! SOURCE_FIELD_NUMBER_OF_COMPONENTS=NUMBER_OF_DIMENSIONS
             ...
             END SELECT
           ENDIF    
          !Do nothing for other type of monodomain
        CASE(EQUATIONS_SET_SETUP_FINISH_ACTION)
           IF(EQUATIONS_SET%SOURCE%SOURCE_FIELD_AUTO_CREATED) THEN
        ...
        IF(ASSOCIATED(CONTROL_LOOP)) THEN
          ...
          IF(ASSOCIATED(PROBLEM)) THEN
           ...
           !   CASE(PROBLEM_MONODOMAIN_GUDUNOV_SPLIT_SUBTYPE)
              CASE(PROBLEM_MONODOMAIN_GUDUNOV_SPLIT_SUBTYPE,PROBLEM_MONODOMAIN_QUASI_STRANG_SPLIT_SUBTYPE)
      ...
      CASE(PROBLEM_SETUP_CELLML_EQUATIONS_TYPE)
        ...
        CASE(PROBLEM_SETUP_START_ACTION)
          ...
          !  IF(PROBLEM%SUBTYPE==PROBLEM_MONODOMAIN_STRANG_SPLIT_SUBTYPE .or. &
           !    & PROBLEM%SUBTYPE==PROBLEM_MONODOMAIN_QUASI_STRANG_SPLIT_SUBTYPE) THEN
...
999 CALL ERRORS("BIODOMAIN_EQUATION_PROBLEM_SUBTYPE_SET",ERR,ERROR)
  ...
  SUBROUTINE BIODOMAIN_EQUATION_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    LOGICAL :: USE_FIBRES
    REAL(DP) :: CONDUCTIVITY(3,3),DPHIDX(3,64),RWG,SUM,gr,Cm,Vr,Ve,K_variable
    ...
    TYPE(EQUATIONS_MATRICES_RHS_TYPE), POINTER :: RHS_VECTOR
    TYPE(EQUATIONS_MATRIX_TYPE), POINTER :: DAMPING_MATRIX,STIFFNESS_MATRIX
    TYPE(FIELD_TYPE), POINTER :: DEPENDENT_FIELD,GEOMETRIC_FIELD,FIBRE_FIELD,MATERIALS_FIELD,INDEPENDENT_FIELD
    TYPE(FIELD_VARIABLE_TYPE), POINTER :: FIELD_VARIABLE,GEOMETRIC_VARIABLE
    TYPE(QUADRATURE_SCHEME_TYPE), POINTER :: QUADRATURE_SCHEME
    TYPE(EQUATIONS_MATRICES_SOURCE_TYPE), POINTER :: SOURCE_VECTOR
    TYPE(VARYING_STRING) :: LOCAL_ERROR

    REAL(DP), POINTER :: INdependentParameters(:),dependentParameters(:),seconddependentParameters(:)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      IF(ASSOCIATED(EQUATIONS)) THEN
        ...
        CASE(EQUATIONS_SET_MONODOMAIN_EQUATION_TYPE)
          ...
          IF(ASSOCIATED(INDEPENDENT_FIELD)) CALL FIELD_INTERPOLATION_PARAMETERS_ELEMENT_GET(FIELD_VALUES_SET_TYPE,ELEMENT_NUMBER,& 
            & EQUATIONS%INTERPOLATION% &
            & INDEPENDENT_INTERP_PARAMETERS(FIELD_U_VARIABLE_TYPE)%PTR,ERR,ERROR,*999)
          IF(ASSOCIATED(SOURCE_VECTOR)) CALL FIELD_INTERPOLATION_PARAMETERS_ELEMENT_GET(FIELD_VALUES_SET_TYPE,ELEMENT_NUMBER, &
            & EQUATIONS%INTERPOLATION% &
          ...
          IF(STIFFNESS_MATRIX%UPDATE_MATRIX.OR.DAMPING_MATRIX%UPDATE_MATRIX.OR.RHS_VECTOR%UPDATE_VECTOR .OR. &
            & SOURCE_VECTOR%UPDATE_VECTOR) THEN
            ...
            DO ng=1,QUADRATURE_SCHEME%NUMBER_OF_GAUSS
              ...
              IF(ASSOCIATED(INDEPENDENT_FIELD)) CALL FIELD_INTERPOLATE_GAUSS(NO_PART_DERIV,BASIS_DEFAULT_QUADRATURE_SCHEME, &
                & ng,EQUATIONS%INTERPOLATION% &
                & INDEPENDENT_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR,ERR,ERROR,*999) 
              IF(ASSOCIATED(SOURCE_VECTOR)) CALL FIELD_INTERPOLATE_GAUSS(NO_PART_DERIV,BASIS_DEFAULT_QUADRATURE_SCHEME,ng, &
                & EQUATIONS%INTERPOLATION% &
                ...
                DO mh=1,FIELD_VARIABLE%NUMBER_OF_COMPONENTS
                  ...
                  DO ms=1,DEPENDENT_BASIS%NUMBER_OF_ELEMENT_PARAMETERS
                    ...
                    DO nh=1,FIELD_VARIABLE%NUMBER_OF_COMPONENTS
                      DO ns=1,DEPENDENT_BASIS%NUMBER_OF_ELEMENT_PARAMETERS
                        ...
                        IF (ASSOCIATED(STIFFNESS_MATRIX)) THEN 
                          IF(STIFFNESS_MATRIX%UPDATE_MATRIX) THEN
                            STIFFNESS_MATRIX%ELEMENT_MATRIX%MATRIX(mhs,nhs)=STIFFNESS_MATRIX%ELEMENT_MATRIX%MATRIX(mhs,nhs)+ &
                              ...
                              & QUADRATURE_SCHEME%GAUSS_BASIS_FNS(ns,NO_PART_DERIV,ng)*RWG*K_variable 
                          ENDIF
                        ELSE
                          LOCAL_ERROR="THE STIFFNESS MATRIX IS NOT ASSOCIATED"
                          CALL FLAG_ERROR(LOCAL_ERROR,ERR,ERROR,*999)
                        ENDIF
                        IF (ASSOCIATED(DAMPING_MATRIX)) THEN  
                          ...
                          ENDIF
                        ELSE
                          LOCAL_ERROR="THE DAMPING MATRIX IS NOT ASSOCIATED"
                          CALL FLAG_ERROR(LOCAL_ERROR,ERR,ERROR,*999)
                        ENDIF
                      ENDDO !ns
                    ENDDO !nh
                    IF (ASSOCIATED(SOURCE_VECTOR)) THEN 
                      ...
                      !Use materials field value: the source is  (Ve-Vr)*gr, we store gr and Vr in material field:
                        Cm= EQUATIONS%INTERPOLATION%MATERIALS_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES(2,1)
                        gr= EQUATIONS%INTERPOLATION%MATERIALS_INTERP_POINT(FIELD_U_VARIABLE_TYPE)%PTR%VALUES & 
                              & (GEOMETRIC_VARIABLE%NUMBER_OF_COMPONENTS+3,1)
                      ...
                      ENDIF
                    ELSE 
                      LOCAL_ERROR="THE SOURCE VECTOR IS NOT ASSOCIATED"
                      CALL FLAG_ERROR(LOCAL_ERROR,ERR,ERROR,*999)
                    ENDIF
          ...
          ENDIF
          CALL FIELD_PARAMETER_SET_DATA_GET(DEPENDENT_FIELD,FIELD_U_VARIABLE_TYPE,FIELD_VALUES_SET_TYPE, &
            & seconddependentParameters,err,error,*999)
        CASE(EQUATIONS_SET_BIDOMAIN_EQUATION_TYPE)
          SELECT CASE(EQUATIONS_SET%SUBTYPE)
          CASE(EQUATIONS_SET_FIRST_BIDOMAIN_SUBTYPE)
          CASE(EQUATIONS_SET_SECOND_BIDOMAIN_SUBTYPE)
